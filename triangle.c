...
/* This reduced source is a callable library.  Read triangle.h for details   */
/*   on the triangulate() interface.                                         */
...
/*   generating a smaller object library.                                    */
...
#include <string.h>
#include <math.h>
#include <stdint.h>   /* uintptr_t: pointer-sized integer for the handle macros */
#ifndef NO_TIMER
#include <sys/time.h>
#endif /* not NO_TIMER */
#ifdef CPU86
...
/*   viri (triangles being eaten), encroached segments, and bad (skinny or   */
/*   too large) triangles.                                                   */
...
/* Data structure for triangulation switches.  This structure                */
...
/*   usesegments: -p, -q, or -c switch; determines whether segments are      */
/*     used at all.                                                          */
/*                                                                           */
...
/********* In-memory transfer and output routines begin here          *********/
/**                                                                         **/
/**                                                                         **/
...
/*                                                                           */
/*  - Initialize constants and parse the switch string.                      */
/*  - Transfer and triangulate the input vertices.                           */
...
/*  - Transfer the requested output arrays to the caller.                    */
/*                                                                           */
/*****************************************************************************/
